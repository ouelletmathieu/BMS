...
main_path = "./data_example/wrong_motif_network/random_motif_nodes_"+str(nodeNb)+".txt"
...
def random_sampling_random_motif():
    ...
    for  k in range(nb_sample):
        ...
        list_motif_to_use_id = random.sample(list_all_motif_id, len(list_wrong_motif))
